...
public:
	static std::shared_ptr<Light> newInstance(const char* lightType, const GLint id, const Vector3& diff, const Vector3& sp, const GLfloat spow, const Vector3& dir, const GLint aObj);
